...
# Based on asterisk-13.23.1.ebuild
...
# Not sure if all these patches still apply/are needed
# /erikw
...
# libedit seems to be necessary by default
# Must look into this further. Maybe the use-flag doesnt properly set the configure option
# /erikw
...
src_prepare() {
	default
# for now use the bundled pjproject
# /erikw
